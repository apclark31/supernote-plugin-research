/**
 * Dev log server - receives debug logs from SuperHub on the Supernote.
 *
...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'POST' && req.url === '/log') {
    ...
    req.on('end', () => {
      ...
      const filename = `superhub-${timestamp}.txt`;
  ...
  if (req.method === 'GET' && req.url === '/') {
    ...
    res.end('SuperHub dev log server running');
    return;
  }
